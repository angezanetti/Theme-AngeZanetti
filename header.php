...
<body>
  <header>
    <nav>
      <?php wp_nav_menu(array('menu'=>'Menuu'));
      /* wp_nav_menu(array('menu'=>'MenuMobile')); */
      ?> 
<select class="phoneList" ONCHANGE="location = this.options[this.selectedIndex].value;">
 <option>Menu</option>
 <option value="/">Accueil</option>
 <option value="/blog/">Blog</option>
 <option value="/mondesvirtuels-seriousgame-wordpress/">Prestations</option>
 <option value="/references/">Références</option>
 <option value="/a-propos-2/">A Propos</option>
